...
public class EmployeeBO {
	...
	/**
	 * Gets the all employee details which will be paginated.
	 *
	 * @return the all employee
	 * @throws DatabaseOperationException the database operation exception
	 * @throws ApplicationException the application exception
	 */
	public List<EmployeeTO> getAllEmployeesByPagination(String maxPage, String ofset) throws DatabaseOperationException, ApplicationException {
		return emp.getAllEmployeesByPagination(maxPage, ofset);
	}
	...
	public int getAllEmployeeCount() throws DatabaseOperationException, ApplicationException {
		return emp.getAllEmployeeCount();
	}
}
